 ...
 function run(dbimportpath,modalId){ 
    ...
    $('#DBURLBtn').off('click').click({dbimportpath:dbimportpath},function(event){
        ...
        function send(dbimportpath){
          ...
          var dataArray={}; 
          var confName = events[0].setSummary;
          ...
          $.ajax({
            ...
            success:function(a,b,c){alert('"'+confName+'" has been well added :\n\t'+events.length+' events\n\t'+locations.length+' locations\n');},
            error:function(a,b,c){alert("Can't import given ontology... (maybe it has been allready imported ? " );},
          });
